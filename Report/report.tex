...
For this purpose we used the baseline model with parameters shown in Table \ref{tab:baseline}, using either the \textit{wiki} or \textit{text8} corpus.
...
We could observe the importance of the model size on our results,
