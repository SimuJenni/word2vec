...
We observe that if we choose the learning rate too high (\textit{e.g.} above $2^{-5}$) the accuracy drops dramatically. The reason for this can be found in the gradient descent update rule, where a high value of $\alpha$ will make the gradients overshoot the minimum.
