...
Cosine+RC   &     \textbf{48.3\%}    &    \textbf{21.6\%}      &    \textbf{23.2\%}    &     63.4\%   &    14.8\%    &   14.4\%     &   \textbf{42.9\%}     &     77.9\%   &    33.8\%    &   \textbf{49.3\%}     &   \textbf{43.5\%}     \\
 \hline
\end{tabular}
\caption{Comparison of different similarity-measures. Results obtained on the generalised question set of \cite{mikolov2013efficient} with a Skip-Gram model trained on the \textit{Text8} corpus. We can observe that cosine-similarity overall performs better compared to the other measures.  Although not a similarity-measure we list the results of our proposed re-centering approach for comparison and note a significant increase in accuracy.}
\end{table*}
