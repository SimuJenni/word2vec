...
When a model gives a wrong answer, our accuracy definition ignore how far it was from the right answer. We tried a different definition of accuracy where we ask the model for its \textit{k} closest answer. We call it a success if this set of answer contains the right one.
