...
\begin{equation}
	v = \underset{v \in f(V)}{\text{argmax }}  d(v, x-y+u)
	\label{eq:anal}
\end{equation}
...
\begin{equation}
	v =  \underset{v \in f(V)}{\text{argmax }}  d(v, x) - d(v, y) + d(v, u)
	\label{eq:anal2}
\end{equation}
...
Models with the additional term of alternative analogy interpretations from Equation \ref{eq:alt} are depicted with \textit{CosMS+}. This has shown further slightly improve the accuracy of the model.
