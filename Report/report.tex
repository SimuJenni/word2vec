...
Cosine    & 45.2\%  & 18.7\%   & 21.3\% & 62.1\% & \textbf{15.5\%} & 15.0\% & 36.8\% & 77.6\% & \textbf{33.9\%} & 45.0\% & 42.0\% \\
...
Cosine+RC   &     \textbf{47.6\%}    &    \textbf{21.6\%}      &    \textbf{23.0\%}    &     63.4\%   &    14.8\%    &   14.4\%     &   \textbf{42.9\%}     &     77.9\%   &    33.7\%    &   \textbf{49.2\%}     &   \textbf{43.5\%}     \\
 \hline
\end{tabular}
...
CBOW+RC    &    63.9\%     &    20.2\%      &    \textbf{43.7\%}    &    \textbf{80.0\%}    &   29.1\%     &    35.4\%  &    \textbf{62.8\%}    &    83.7\%   &    45.2\%    &     67.9\%   & 59.0\%        \\
Skip-Gram &    \textbf{70.7\%}     &     20.8\%     &     34.6\%   &    71.3\%    &    \textbf{29.2\%}    &   37.1\%     &   55.1\%     &    88.6\%    &   48.9\%     &    68.3\%    &    58.3\%   \\
Skip-Gram+RC  &     70.6\%    &    \textbf{21.3\%}      &    35.7\%   &     70.8\%   &    28.9\%    &   \textbf{38.9\%}     &   59.5\%    &     \textbf{89.5\%}   &    \textbf{49.8\%}    &   \textbf{70.0\%}    &   \textbf{59.6\%}     \\
 \hline
\end{tabular}
\caption{Performance comparison of models with and without our proposed re-centering approach. Results obtained on the generalised question set of \cite{mikolov2013efficient} with models trained on the \textit{Wiki} corpus.}
\end{table*}
...
CBOW+RC    &    34.4\%     &    16.0\%      &    15.6\%    &    \textbf{79.7\%}    &   15.3\%     &    \textbf{21.2\%}  &    42.3\%   &    65.6\%   &    31.2\%    &     45.7\%   & 40.0\%        \\
Skip-Gram &    46.0\%     &     18.7\%     &     21.0\%   &    62.1\%    &    \textbf{15.5\%}    &   15.0\%     &   36.8\%     &    77.6\%    &   \textbf{33.9\%}     &    44.9\%    &    42.1\%   \\
Skip-Gram+RC  &     \textbf{47.6\%}    &    \textbf{21.6\%}      &    \textbf{23.0\%}   &     63.4\%   &    14.8\%    &   14.4\%     &   \textbf{42.9\%}    &     \textbf{77.9\%}   &    33.7\%    &   \textbf{49.2\%}    &   \textbf{43.5\%}     \\
 \hline
\end{tabular}
\caption{Performance comparison of models with and without our proposed re-centering approach. Results obtained on the generalised question set of \cite{mikolov2013efficient} with models trained on the \textit{Text8} corpus.}
\end{table*}
